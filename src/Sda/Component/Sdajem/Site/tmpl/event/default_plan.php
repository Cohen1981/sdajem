    ...
    <div class="well">
        ...
        <div class="buttonContainer">
            ...
            <button class='btn me-2 btn-primary col-auto d-none d-sm-inline-block'
                    ...
                    data-joomla-dialog='{"popupType": "iframe","width":"90vw", "height": "90vh", "src":"?option=com_sdajem&tmpl=component&view=fittings&layout=modal&eventId=<?php echo $event->id; ?>&callContext=event.planing"}'>
